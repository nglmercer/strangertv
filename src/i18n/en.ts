export const en = {
  ...
  expandFooter: 'Show details',
  collapseFooter: 'Hide details',
  profileTitle: 'Complete your profile',
  mustBe18: 'You must be 18 or older to use this website.',
  continueWithGoogle: 'Continue with Google',
  googleFinish: 'Almost there',
  googleFinishTitle: 'Confirm your birthday',
  googleFinishAction: 'Create account',
  ...
  signInToSocial: 'Sign in to add friends and follow',
  peerNotSignedIn: 'Peer is not signed in',
  friends: 'Friends',
...
Conversations are not private from your peer; treat strangers carefully.`,
  ...
  searchFriendsToAdd: 'Search friends to add',
  ...
  noConversationsHint: 'Start one from a friend or create a group.',
  chooseConversationHint: 'Pick someone on the left, or start a new group.',
  retry: 'Retry',
  ...
  addFriendHint: 'Find someone by the email they signed up with.',
  ...
  socialPointFriends: 'Add friends and message them directly',
  // Share match prefs
  ...
  groupMatchInviteTitle: 'Group Match Invitation',
  groupMatchInviteBody: 'invites you to join a group match',
  groupMatchInviteAccept: 'Accept',
  groupMatchInviteDeny: 'Decline',
  // SharedPrefs
  public: 'Public',
  private: 'Private',
  ...
  groupLayoutSides: 'Sides',
  groupLayoutSidesHint: 'The remote party takes the left; you and your group take the right.',

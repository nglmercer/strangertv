...
export const icons = {
  ...
  // Gender glyphs: mars / venus / transgender, so the "looking for" options are
  // told apart at a glance instead of repeating one generic person icon.
  genderMale: 'M15.5 3v2h2.09l-3.11 3.11A5.5 5.5 0 1 0 15.4 9.5l3.1-3.09V8.5h2V3zM10.5 19a3.5 3.5 0 1 1 0-7 3.5 3.5 0 0 1 0 7z',
  genderFemale: 'M12 2a5.5 5.5 0 0 0-1 10.91V15H8.5v2H11v3h2v-3h2.5v-2H13v-2.09A5.5 5.5 0 0 0 12 2zm0 2a3.5 3.5 0 1 1 0 7 3.5 3.5 0 0 1 0-7z',
  genderOther:
    'M17.5 2v2h1.09l-2.2 2.2a5.5 5.5 0 0 0-3.39-1.16h-.5V3.5h1.75v-2H9.75v2h1.75v1.54h-.5a5.5 5.5 0 1 0 5.49 8.02l.01-.01a5.5 5.5 0 0 0-.11-5.29l2.11-2.1V8.5h2V2zM11 18.5a3.5 3.5 0 1 1 0-7 3.5 3.5 0 0 1 0 7z',
  search:
